{
  ...
  // Nominal
  //TString input_dir_nom  = "/hadoop/cms/store/user/jgwood/condor/stop_1l_babies/stop_babies__CMS3_V070411__BabyMaker_V0704X_v7__20151208/merged_files/Skims_SR__20160125/";  
  ...
  TString input_dir_nom  = "/hadoop/cms/store/user/jgwood/condor/stop_1l_babies/stop_babies__CMS3_V070411__BabyMaker_V0704X_v9__20160127/merged_files/Skims_SR__20160202/";  
  ...
  // JESup
  //TString input_dir_jesUp  = "/hadoop/cms/store/user/jgwood/condor/stop_1l_babies/stop_babies_JECup__CMS3_V070411__BabyMaker_V0704X_v7__20151208/merged_files/Skims_SR__JECup__20160125/";  
  //TString input_dir_jesUp  = "/hadoop/cms/store/user/jgwood/condor/stop_1l_babies/stop_babies_JECup__CMS3_V070411__BabyMaker_V0704X_v7__20151208/merged_files/";  
  ...
  // JESdown
  //TString input_dir_jesDn  = "/hadoop/cms/store/user/jgwood/condor/stop_1l_babies/stop_babies_JECdown__CMS3_V070411__BabyMaker_V0704X_v7__20151208/merged_files/Skims_SR__JECdown__20160125/";  
  //TString input_dir_jesDn  = "/hadoop/cms/store/user/jgwood/condor/stop_1l_babies/stop_babies_JECdown__CMS3_V070411__BabyMaker_V0704X_v7__20151208/merged_files/";  
  ...
  if(doMC){
    for(int iBaby=0; iBaby<(int)inDirs.size(); iBaby++){
      ...
      input_name  = input_dir+"T6bbWW_mStop425_mCh400_mLSP50_25ns*.root";
      output_name = output_dir+"histos__T6bbWW_mStop425_mCh400_mLSP50_25ns.root";
      ch = new TChain("t"); 
      ch->Add(input_name);
      stopBabyLooper(ch, output_name); 
      ch->~TChain();
      ...
      */
      ...
      ch = new TChain("t"); 
      ch->Add(input_name);
      //stopBabyLooper(ch, output_name,true,100000); 
      stopBabyLooper(ch, output_name); 
      ch->~TChain();
