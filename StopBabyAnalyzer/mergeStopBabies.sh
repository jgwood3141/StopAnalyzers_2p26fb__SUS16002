...
do
	...
	BASE_DIR=$TOP_DIR/$x
        ...
        # Merge data samples
        #hadd -f $BASE_DIR/histos__data.root $BASE_DIR/histos__data_muon_eg_2015B_50ns.root 
	...
	hadd -f $BASE_DIR/histos__VJets_25ns.root $BASE_DIR/histos__DYJets_25ns.root $BASE_DIR/histos__WJets_25ns.root
        ...
        # Merge TTV 
	hadd -f $BASE_DIR/histos__TTV_25ns.root $BASE_DIR/histos__TTWJetsToLNu_amcnlo_pythia8_25ns_noNegYield.root $BASE_DIR/histos__TTWJetsToQQ_amcnlo_pythia8_25ns_noNegYield.root $BASE_DIR/histos__TTZToQQ_amcnlo_pythia8_25ns_noNegYield.root $BASE_DIR/histos__TTZToLLNuNu_M-10_amcnlo_pythia8_25ns_noNegYield.root 
