...
void plotMaker_pas1(){
  ...
  TFile *data_file;
  if(plotData) data_file = new TFile(inDir+"histos__data_25ns_noNegYield.root", "read");
  ...
  // 0 lepton
  TFile *f_allBkg = new TFile(inDir+"histos__allBkg_25ns_noNegYield.root", "read");
  ...
  TFile *f_stop_425_325 = new TFile(inDir+"histos__stop_425_325_noNegYield.root", "read");
  ...
  TFile *f_stop_500_325 = new TFile(inDir+"histos__stop_500_325_noNegYield.root", "read");
  sig_classy_names.push_back(hName_incl);
  ...
  TFile *f_stop_650_325 = new TFile(inDir+"histos__stop_650_325_noNegYield.root", "read");
  sig_classy_names.push_back(hName_incl);
  ...
  TFile *f_stop_850_100 = new TFile(inDir+"histos__stop_850_100_noNegYield.root", "read");
  sig_classy_names.push_back(hName_incl);
